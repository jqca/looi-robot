...
{{
  ...
  "emotion": "idle か happy か excited か thinking か sad か surprised か sleep のどれか",
...
★おやすみモード：
「おやすみ」「ねむい」「もうねる」「ねるね」「バイバイ」などと言われたら、
やさしくおやすみのあいさつをして emotion を "sleep" にしてください。
例: 「おやすみ～！いいゆめみてね！またあそぼうね！」+ emotion: "sleep"
"""
...
def kids_chat():
    ...
    try:
        ...
        valid_emo = {"idle", "happy", "excited", "thinking", "sad", "surprised", "sleep"}
